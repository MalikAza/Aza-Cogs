...
* V10 Dice: the game use a V10 dice who is an improve of the 10 dice, adding critical success, failure and critical failure which add fun to it. You can see more about it at [roll.org](https://rolz.org/wiki/page?w=help&n=BasicCodes)

## Getting started
### Installation
Simply use Red bot command `cogboard search idicebattle` and install the cog.
### Usage
Simply do command `idice` to see all the available commands and `idice help <nameofcommand>` to see more informations.
